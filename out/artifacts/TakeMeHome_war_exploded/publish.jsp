...
<%@ page import="controller.PublishController" %>
...
<div class="container">
    ...
    <div class="content">
        <div class="content-bottom store">
            <h3>我的发布</h3>
            <%
                List<Pet> publish = PublishController.getPublish(username);
                if(publish==null || publish.size() == 0){
            %>
            <div style="text-align: center; margin-top: 30px;"><h4 class="title">我的发布是空的。</h4></div>
            <%
            }
            else{
            %>
            <div class="bottom-grid">
                ...
                <div class="col-md-3 store-top">
                    <div class="bottom-grid-top">
                        <a href="edit.jsp?id=<%=pet.getPetId()%>"><img style="height:250px;" class="img-responsive" src="images/<%=pet.getPetImagePath()[0]%>" alt="" >
                            <div class="pre">
                                <p><%=pet.getPetName()%></p>
            ...
            <div style="padding-left: 20px;">
                <p class="cart-out"><br><a href="edit.jsp">新发布</a></p>
            </div>
        </div>
    </div>
</div>
