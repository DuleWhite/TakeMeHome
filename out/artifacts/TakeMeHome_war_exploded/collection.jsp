...
<!--header-->
	<div class="container">
		...
		<div class="content">
            ...
            %>
    	    <div style="text-align: center; margin-top: 30px;"><h4 class="title">我的收藏是空的。</h4></div>
            <%
                }
                else{
            %>
            ...
            <%
                    for (String collectionItem:collection) {
                        Pet pet = PetsController.getPetById(collectionItem);
            %>
            ...
            <div style="padding-left: 20px;">
    	        <p class="cart-out"><br>点击<a href="index.jsp">这里</a>继续浏览</p>
            </div>
            </div>
		</div>
    </div>
